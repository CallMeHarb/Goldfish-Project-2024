...
par(bty = "n")
plot(c(0,3), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = "Mass (g)",
     ylab = "FL (mm)", las = 1, cex.lab = 2, cex.main = 3, xlim=c(0,200), ylim = c(0,200))
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
lines((Weight.124.predict),FL.predict, col = "gold", lty = 2, lwd = 3)
lines((Weight.88.predict),FL.predict, col = "green", lty = 2, lwd = 3)
lines((Weight.127.predict),FL.predict, col = "blue", lty = 2, lwd = 3)
lines((Weight.104.2022.predict),FL.predict, col = "brown", lty = 2, lwd = 3)
lines((Weight.5A.predict),FL.predict, col = "orange", lty = 2, lwd = 3)
lines((Weight.89.predict),FL.predict, col = "purple", lty = 2, lwd = 3)
lines((Weight.104.2021.predict),FL.predict, col = "black", lty = 2, lwd = 3)
...
optimal.curve = ggplot(data = Final.b, aes(b.value, ASM_AIC.Golfish)) +
  ...
  theme(axis.title.x = element_text(size = 30), axis.title.y = element_text(size = 30), axis.text = element_text(size = 22), plot.margin = margin(30, 30, 30, 30)) +
  geom_vline(xintercept = -0.32, colour = 'red', linewidth = 0.7, linetype = "dashed") + 
  geom_segment(x = -0.57, xend = -0.51, y = 206.1676, yend = 206.1676, linewidth = 0.8) +
  geom_segment(x = -0.16, xend = -0.10, y = 206.1170, yend = 206.1170, linewidth = 0.8) +
  geom_segment(x = -0.54, xend = -0.54, y = 206.1676, yend = 0, linewidth = 0.8, linetype = "dashed") +
  geom_segment(x = -0.13, xend = -0.13, y = 206.1170, yend = 0, linewidth = 0.8, linetype = "dashed") +
  annotate("text", x = 0, y = 215, label = "Optimal b = -0.32", color = "black", size = 7.5)
optimal.curve
...
optimal.curve.noSA = ggplot(data= Final.b, aes(b.value, ASM_AIC.Golfish.noSA)) +
  ...
  theme(axis.title.x = element_text(size = 30), axis.title.y = element_text(size = 30), axis.text = element_text(size = 22), plot.margin = margin(30, 30, 30, 30)) +
  geom_vline(xintercept = -0.33, colour = 'red', linewidth = 0.7, linetype = "dashed") + 
  geom_segment(x = -0.57, xend = -0.51, y = 205.4072, yend = 205.4072, linewidth = 0.8) +
  geom_segment(x = -0.17, xend = -0.11, y = 205.5584, yend = 205.5584, linewidth = 0.8) +
  geom_segment(x = -0.54, xend = -0.54, y = 205.4072, yend = 0, linewidth = 0.8, linetype = "dashed") +
  geom_segment(x = -0.14, xend = -0.14, y = 205.5584, yend = 0, linewidth = 0.8, linetype = "dashed") +
  annotate("text", x = 0, y = 215, label = "Optimal b = -0.33", color = "black", size = 7.5)
optimal.curve.noSA
...
Densityvsbodysize = ggplot(data = Explanation.dataframe, aes(density.per.ha, log(mean.body.size))) +
  ...
  theme(axis.title.x = element_text(size = 30), axis.title.y = element_text(size = 30), axis.text = element_text(size = 25), plot.margin = margin(40, 40, 40, 40)) + 
...
model.abundance = lm(eDNA ~ ASM, data = goldfish.ASM.abund)
summary(model.abundance)

model.biomass = lm(eDNA ~ ASM, data = goldfish.ASM.biomass)
summary(model.biomass)
...
eDNA.estimates.abundance = model.abundance$coefficients[1] + ASM.opt*(model.abundance$coefficients[2])
eDNA.estimates.biomass = model.biomass$coefficients[1] + ASM.bio*(model.biomass$coefficients[2])
...
plot(c(0,1), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = expression(paste("ASM"^"-0.32")),
     ylab = "eDNA (Thousands Copies/L)", las = 1, cex.lab = 3.5, cex.main = 3.5, xlim=c(0,80000), ylim = c(0,600) )
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
points(goldfish.ASM$ASM, goldfish.ASM$eDNA/1000, col = "black", pch = 16, cex = 2)
...
plot(c(0,1), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = expression(paste(Abundance)),
     ylab = "", las = 1, cex.lab = 3.5, cex.main = 3.5, xlim=c(0,100000), ylim = c(0,600) )
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
points(final.dat$b0/final.dat$Surface.Area..hectare., goldfish.ASM$eDNA/1000, col = "black", pch = 16, cex = 2)
...
plot(c(0,1), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = expression(paste(Biomass (kg))),
     ylab = "", las = 1, cex.lab = 3.5, cex.main = 3.5, xlim=c(0,800), ylim = c(0,600) )
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
points((final.dat$b100/final.dat$Surface.Area..hectare.)/1000, goldfish.ASM$eDNA/1000, col = "black", pch = 16, cex = 2)
lines(ASM.bio/1000, eDNA.estimates.biomass/1000, col = "black", lty = 1, lwd = 2)
...
par(bty = "n")
plot(c(0,1), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = expression(paste("ASM"^"-0.32")),
     ylab = "eDNA (Thousands Copies/L)", las = 1, cex.lab = 3, cex.main = 3, xlim=c(0,15000), ylim = c(0,600) )
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
points(goldfish.ASM.noSACorr$ASM, goldfish.ASM.noSACorr$eDNA/1000, col = "black", pch = 16, cex = 1.75)
...
par(bty = "n")
plot(c(0,1), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = expression(paste(Abundance)),
     ylab = "", las = 1, cex.lab = 3, cex.main = 3, xlim=c(0,20000), ylim = c(0,600) )
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
points(final.dat$b0, goldfish.ASM.noSACorr$eDNA/1000, col = "black", pch = 16, cex = 1.75)
...
par(bty = "n")
plot(c(0,1), c(5,20), xaxt = "n", yaxt = "n", type = "n", xlab = expression(paste(Biomass (kg))),
     ylab = "", las = 1, cex.lab = 3, cex.main = 3, xlim=c(0,150), ylim = c(0,600) )
axis(1, pos = 0, col = "black", cex.axis = 2)
axis(2, pos = 0.0, col = "black", cex.axis = 2)
points(final.dat$b100/1000, goldfish.ASM.noSACorr$eDNA/1000, col = "black", pch = 16, cex = 1.75)
